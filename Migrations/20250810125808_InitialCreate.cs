    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Addresses", x => x.SchoolId);
                    table.ForeignKey(
                        name: "FK_Addresses_School_SchoolId",
                        column: x => x.SchoolId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Person_ProfilePictureUrl = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Person_FirstName = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Person_MiddleName = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Person_LastName = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Person_Sex = table.Column<int>(type: "int", nullable: false),
                    Person_DateOfEnrollment = table.Column<DateTime>(type: "date", nullable: false),
                    Person_DateOfBirth = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Person_StateOfOrigin = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Person_LgaOfOrigin = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Person_Email = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Person_PhoneNumber = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Person_PersonalCalendarId = table.Column<int>(type: "int", nullable: false),
                    Person_EducationLevel = table.Column<int>(type: "int", nullable: false),
                    Person_ClassLevel = table.Column<int>(type: "int", nullable: false),
                    Person_SchoolFeesId = table.Column<int>(type: "int", nullable: true),
                    Person_EmergencyContact = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Person_IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Person_IsArchived = table.Column<bool>(type: "tinyint(1)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Guardians_CalendarModel_Person_PersonalCalendarId",
                        column: x => x.Person_PersonalCalendarId,
                        principalTable: "CalendarModel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Guardians_SchoolFees_Person_SchoolFeesId",
                        column: x => x.Person_SchoolFeesId,
                        principalTable: "SchoolFees",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Staff_CalendarModel_Person_PersonalCalendarId",
                        column: x => x.Person_PersonalCalendarId,
                        principalTable: "CalendarModel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Staff_SchoolFees_Person_SchoolFeesId",
                        column: x => x.Person_SchoolFeesId,
                        principalTable: "SchoolFees",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentLearningPathId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_CalendarModel_Person_PersonalCalendarId",
                        column: x => x.Person_PersonalCalendarId,
                        principalTable: "CalendarModel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Students_LearningPaths_CurrentLearningPathId",
                        column: x => x.CurrentLearningPathId,
                        principalTable: "LearningPaths",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Students_SchoolFees_Person_SchoolFeesId",
                        column: x => x.Person_SchoolFeesId,
                        principalTable: "SchoolFees",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Author_ProfilePictureUrl = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Author_FirstName = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Author_MiddleName = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Author_LastName = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Author_Sex = table.Column<int>(type: "int", nullable: false),
                    Author_DateOfEnrollment = table.Column<DateTime>(type: "date", nullable: false),
                    Author_DateOfBirth = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Author_StateOfOrigin = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Author_LgaOfOrigin = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Author_Email = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Author_PhoneNumber = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Author_PersonalCalendarId = table.Column<int>(type: "int", nullable: false),
                    Author_EducationLevel = table.Column<int>(type: "int", nullable: false),
                    Author_ClassLevel = table.Column<int>(type: "int", nullable: false),
                    Author_SchoolFeesId = table.Column<int>(type: "int", nullable: true),
                    Author_EmergencyContact = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Author_IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Author_IsArchived = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ...
                    DiscussionThreadId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscussionPost", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiscussionPost_CalendarModel_Author_PersonalCalendarId",
                        column: x => x.Author_PersonalCalendarId,
                        principalTable: "CalendarModel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscussionPost_DiscussionThread_DiscussionThreadId1",
                        column: x => x.DiscussionThreadId1,
                        principalTable: "DiscussionThread",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DiscussionPost_SchoolFees_Author_SchoolFeesId",
                        column: x => x.Author_SchoolFeesId,
                        principalTable: "SchoolFees",
                        principalColumn: "Id");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscussionPost_Author_PersonalCalendarId",
                table: "DiscussionPost",
                column: "Author_PersonalCalendarId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscussionPost_Author_SchoolFeesId",
                table: "DiscussionPost",
                column: "Author_SchoolFeesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscussionPost_DiscussionThreadId1",
                table: "DiscussionPost",
                column: "DiscussionThreadId1",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Guardians_Person_PersonalCalendarId",
                table: "Guardians",
                column: "Person_PersonalCalendarId");

            migrationBuilder.CreateIndex(
                name: "IX_Guardians_Person_SchoolFeesId",
                table: "Guardians",
                column: "Person_SchoolFeesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Staff_Person_PersonalCalendarId",
                table: "Staff",
                column: "Person_PersonalCalendarId");

            migrationBuilder.CreateIndex(
                name: "IX_Staff_Person_SchoolFeesId",
                table: "Staff",
                column: "Person_SchoolFeesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_Person_PersonalCalendarId",
                table: "Students",
                column: "Person_PersonalCalendarId");

            migrationBuilder.CreateIndex(
                name: "IX_Students_Person_SchoolFeesId",
                table: "Students",
                column: "Person_SchoolFeesId");
