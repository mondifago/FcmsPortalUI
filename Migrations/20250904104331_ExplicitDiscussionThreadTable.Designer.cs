...
namespace FcmsPortalUI.Migrations
{
    ...
    [Migration("20250904104331_ExplicitDiscussionThreadTable")]
    partial class ExplicitDiscussionThreadTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FcmsPortal.Models.DiscussionThread", b =>
                {
                    ...
                    b.HasOne("FcmsPortal.Models.DiscussionPost", "FirstPost")
                        .WithOne()
                        .HasForeignKey("FcmsPortal.Models.DiscussionThread", "FirstPostId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
