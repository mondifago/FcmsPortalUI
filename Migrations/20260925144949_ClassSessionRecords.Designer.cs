...
namespace FcmsPortalUI.Migrations
{
    ...
    [Migration("20260925144949_ClassSessionRecords")]
    partial class ClassSessionRecords
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FcmsPortal.Models.ArchivedCourseGrade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ArchivedStudentGradeId")
                        .HasColumnType("int");
                    ...
                    b.Property<double>("HomeworkAverage")
                        .HasColumnType("double");
                    ...
                    b.HasIndex("ArchivedStudentGradeId");

                    b.ToTable("ArchivedCourseGrades");
                });

            modelBuilder.Entity("FcmsPortal.Models.ArchivedLearningPathGrade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("AverageClassGrade")
                        .HasColumnType("double");
                    ...
                    b.ToTable("ArchivedLearningPathGrades");
                });
            ...
            modelBuilder.Entity("FcmsPortal.Models.ArchivedStudentGrade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ArchivedLearningPathGradeId")
                        .HasColumnType("int");

                    b.Property<int?>("ArchivedReportCardId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ArchivedLearningPathGradeId");

                    b.HasIndex("ArchivedReportCardId");

                    b.ToTable("ArchivedStudentGrades");
                });
            ...
            modelBuilder.Entity("FcmsPortal.Models.ArchivedTestGrade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ArchivedCourseGradeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FcmsPortal.Models.ClassSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClassLevel", "Semester", "DateTime");
            ...
            modelBuilder.Entity("FcmsPortal.Models.ClassSessionRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClassSessionId", "AcademicPeriodId")
                        .IsUnique();
            ...
            modelBuilder.Entity("FcmsPortal.Models.DiscussionThread", b =>
                {
                    ...
                    b.Property<int>("ClassSessionRecordId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClassSessionRecordId");
            ...
            modelBuilder.Entity("FcmsPortal.Models.LearningPath", b =>
                {
                    ...
                    b.HasIndex("ClassLevel", "Semester", "AcademicYearStart");
            ...
            modelBuilder.Entity("FcmsPortal.Models.Quote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FcmsPortal.Models.ArchivedCourseGrade", b =>
                {
                    b.HasOne("FcmsPortal.Models.ArchivedStudentGrade", "ArchivedStudentGrade")
                        .WithMany("CourseGrades")
                        .HasForeignKey("ArchivedStudentGradeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ArchivedStudentGrade");
                });
            ...
            modelBuilder.Entity("FcmsPortal.Models.ArchivedStudentGrade", b =>
                {
                    b.HasOne("FcmsPortal.Models.ArchivedLearningPathGrade", "ArchivedLearningPathGrade")
                        .WithMany("StudentGrades")
                        .HasForeignKey("ArchivedLearningPathGradeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FcmsPortal.Models.StudentReportCard", "ArchivedReportCard")
                        .WithMany()
                        .HasForeignKey("ArchivedReportCardId");

                    b.Navigation("ArchivedLearningPathGrade");

                    b.Navigation("ArchivedReportCard");
                });

            modelBuilder.Entity("FcmsPortal.Models.ArchivedTestGrade", b =>
                {
                    b.HasOne("FcmsPortal.Models.ArchivedCourseGrade", "ArchivedCourseGrade")
                        .WithMany("TestGrades")
                        .HasForeignKey("ArchivedCourseGradeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ArchivedCourseGrade");
                });
            ...
            modelBuilder.Entity("FcmsPortal.Models.ClassSessionRecord", b =>
                {
                    b.HasOne("FcmsPortal.Models.AcademicPeriod", "AcademicPeriod")
                        .WithMany()
            ...
            modelBuilder.Entity("FcmsPortal.Models.DiscussionThread", b =>
                {
                    b.HasOne("FcmsPortal.Models.ClassSessionRecord", "ClassSessionRecord")
            ...
            modelBuilder.Entity("FcmsPortal.Models.Homework", b =>
                {
                    b.HasOne("FcmsPortal.Models.ClassSessionRecord", "ClassSessionRecord")
                        ...
                        .HasForeignKey("FcmsPortal.Models.Homework", "ClassSessionRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FcmsPortal.Models.Quote", b =>
                {
                    b.HasOne("FcmsPortal.Models.Person", "AddedBy")
                        .WithMany()
