...
namespace FcmsPortalUI.Migrations
{
    ...
    [Migration("20250810125808_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FcmsPortal.Models.DiscussionPost", b =>
                {
                    ...
                    b.Property<int?>("DiscussionThreadId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DiscussionThreadId1")
                        .IsUnique();
            ...
            modelBuilder.Entity("FcmsPortal.Models.Staff", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("WorkExperience")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("FcmsPortal.Models.DiscussionPost", b =>
                {
                    ...
                    b.HasOne("FcmsPortal.Models.DiscussionThread", null)
                        .WithOne("FirstPost")
                        .HasForeignKey("FcmsPortal.Models.DiscussionPost", "DiscussionThreadId1");

                    b.OwnsOne("FcmsPortal.Models.Person", "Author", b1 =>
                        {
                            b1.Property<int>("DiscussionPostId")
                                .HasColumnType("int");

                            b1.Property<int>("ClassLevel")
                                .HasColumnType("int");

                            b1.Property<DateTime>("DateOfBirth")
                                .HasColumnType("datetime(6)");

                            b1.Property<DateTime>("DateOfEnrollment")
                                .HasColumnType("date");
                            ...
                            b1.Property<int>("PersonalCalendarId")
                                .HasColumnType("int");
                            ...
                            b1.HasKey("DiscussionPostId");

                            b1.HasIndex("PersonalCalendarId");

                            b1.HasIndex("SchoolFeesId");

                            b1.ToTable("DiscussionPost");

                            b1.WithOwner()
                                .HasForeignKey("DiscussionPostId");

                            b1.HasOne("FcmsPortal.Models.CalendarModel", "PersonalCalendar")
                                .WithMany()
                                .HasForeignKey("PersonalCalendarId")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();

                            b1.HasOne("FcmsPortal.Models.SchoolFees", "SchoolFees")
                                .WithMany()
                                .HasForeignKey("SchoolFeesId");

                            b1.Navigation("PersonalCalendar");
            ...
            modelBuilder.Entity("FcmsPortal.Models.FileAttachment", b =>
                {
                    ...
                    b.HasOne("FcmsPortal.Models.Student", null)
                        .WithMany("FinalResultAttachments")
                        .HasForeignKey("StudentId");
                });
            ...
            modelBuilder.Entity("FcmsPortal.Models.Guardian", b =>
                {
                    ...
                    b.OwnsOne("FcmsPortal.Models.Person", "Person", b1 =>
                        {
            ...
            modelBuilder.Entity("FcmsPortal.Models.Payment", b =>
                {
                    b.HasOne("FcmsPortal.Models.SchoolFees", null)
                        .WithMany("Payments")
                        .HasForeignKey("SchoolFeesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FcmsPortal.Models.LearningPath", b =>
                {
                    ...
                    b.Navigation("StudentsWithAccess");
                });
            ...
            modelBuilder.Entity("FcmsPortal.Models.Student", b =>
                {
                    ...
                    b.Navigation("FinalResultAttachments");
                });
